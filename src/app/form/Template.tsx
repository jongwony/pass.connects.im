    ...
    <div className="w-full max-w-md mx-auto space-y-8">
      <div className="relative rounded-2xl">
        ...
        <button
          type="button"
          onClick={handlePrev}
          className="absolute left-2 top-1/2 -translate-y-1/2 p-2 rounded-full bg-zinc-200 dark:bg-zinc-800 hover:bg-opacity-80 transition-colors"
        >
        ...
        <button
          type="button"
          onClick={handleNext}
          className="absolute right-2 top-1/2 -translate-y-1/2 p-2 rounded-full bg-zinc-200 dark:bg-zinc-800 hover:bg-opacity-80 transition-colors"
        >
