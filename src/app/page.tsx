      ...
      <div className="flex flex-col sm:flex-row p-8 gap-8">
        <div className="relative mt-8 border border-gray-600 rounded-3xl">
          <header className="flex flex-col p-8 gap-4">
            <Share width={48} height={48} />
            <h1 className="text-xl sm:text-2xl">QR 코드로 오프라인에서도 내 정보를 손쉽게 공유하세요.</h1>
        ...
        <div className="relative mt-8 border border-gray-600 rounded-3xl">
          <header className="flex flex-col p-8 gap-4">
            ...
            <h1 className="text-xl sm:text-2xl">종이 명함 없이 QR로 내 프로필을 공유하세요.</h1>
        ...
        <div className="relative mt-8 border border-gray-600 rounded-3xl">
          <header className="flex flex-col p-8 gap-4">
            ...
            <h1 className="text-xl sm:text-2xl">직함과 소개를 더해 나만의 명함을 만드세요.</h1>
